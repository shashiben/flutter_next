      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            _buildSectionTitle(
              context,
              'Container with Custom Styling & Alignment',
              sub: true,
            ),
            _buildExplanation(
              context,
            ...
            NextRow(
              children: [
                NextCol(
                  sizes: 'col-md-8',
                  child: _exampleBox(
                    'Takes 8 of 12 columns on MD and up',
                ...
                NextCol(
                  sizes: 'col-md-4',
                  child: _exampleBox(
                    'Takes 4 of 12 columns on MD and up',
            ...
            _buildSectionTitle(
              context,
              'Example 2: Responsive Offsetting',
              sub: true,
            ),
            NextRow(
              children: [
            ...
            _buildSectionTitle(
              context,
              'Example 2: Complex Reordering (3+ items)',
              sub: true,
            ),
            NextRow(
              children: [
                NextCol(
                  ...
                  child: _exampleBox(
                    'Item X (Third on XS, First on MD)',
                    Colors.purple.shade100,
                  ),
                ),
                NextCol(
                  ...
                  child: _exampleBox(
                    'Item Y (First on XS, Second on MD)',
                ...
                NextCol(
                  ...
                  child: _exampleBox(
                    'Item Z (Second on XS, Third on MD)',
            ...
            _buildSectionTitle(
              context,
              'Example 1: Hide on Specific Breakpoints',
              sub: true,
            ),
            NextRow(
              children: [
            ...
            _buildSectionTitle(
              context,
              'Example 2: Show only on specific breakpoints',
              sub: true,
            ),
            _buildExplanation(
              context,
            ...
            _buildSectionTitle(
              context,
              'Example 1: Show on specific breakpoints',
              sub: true,
            ),
            NextResponsiveVisibility(
              breakpoints: 'lg xl xxl',
              child: _exampleBox(
                'Visible on LG, XL, XXL screens',
            ...
            _buildSectionTitle(
              context,
              'Example 2: Show only on one breakpoint',
              sub: true,
            ),
            NextResponsiveVisibility(
              breakpoints: 'md',
            ...
            _buildSectionTitle(
              context,
              'Example 3: Swapping UI sections',
              sub: true,
            ),
            _buildExplanation(
              context,
            ...
            NextResponsiveVisibility(
              breakpoints: 'md lg',
              child: _exampleBox(
                'Tablet/Desktop View Content (MD, LG)',
                Colors.lightGreen.shade100,
                height: 80,
              ),
            ),
            NextResponsiveVisibility(
              breakpoints: 'xl xxl',
              child: _exampleBox(
                'Large Desktop View Content (XL, XXL)',
