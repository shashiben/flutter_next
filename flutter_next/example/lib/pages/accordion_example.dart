      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            NextAccordion(
              title: const Text('What is Flutter Next?'),
            ...
            NextAccordion(
              title: const Text('How to use NextAccordion?'),
              children: const <Widget>[
                ListTile(
                  title: Text('Usage'),
                  subtitle: Text(
            ...
            NextAccordion(
              title: const Text('This accordion starts expanded'),
            ...
            NextAccordion(
              ...
              subtitle: const Text('Click to learn more'),
              children: const <Widget>[
                ListTile(
